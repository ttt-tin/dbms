                                ...
                                <div class="hidden sm:flex sm:items-center sm:ml-6" v-if="usePage().props.auth.user.role_id == 1">
                                    ...
                                    <div class="ml-3 relative">
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                <DropdownLink :href="route('subject.create')"> Tạo mới môn học </DropdownLink>
                                                <DropdownLink :href="route('subject.index')"> Danh sách môn học </DropdownLink>
                                                <DropdownLink :href="route('import_subject.create')"> Import csv </DropdownLink>
                                                <!-- <DropdownLink :href="route('teacherToSubjects.new')"> Thêm giảng viên vào môn học </DropdownLink> -->
                                            </template>
                                        </Dropdown>
                                    </div>
                                </div>
                                ...
                                <div class="hidden sm:flex sm:items-center sm:ml-6" v-if="usePage().props.auth.user.role_id == 1">
                                    ...
                                    <div class="ml-3 relative">
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                <DropdownLink :href="route('student.create')"> Tạo mới </DropdownLink>
                                                <!-- <DropdownLink :href="route('student.index')"> Danh sách </DropdownLink> -->
                                                <DropdownLink :href="route('import_student.create')"> Import csv </DropdownLink>
                                            </template>
                                        </Dropdown>
                                    </div>
                                </div>
